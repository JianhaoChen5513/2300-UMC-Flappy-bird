...
public class BirdGame extends JPanel {
    ...
    /*game over*/
    public boolean gameOver;//jujgment game over
    public BufferedImage gameOverImage;//gameover screen
    ...
    public void action() throws Exception {
        while(true) {
            if(!gameOver) {
                ...
                column1.step();
                column2.step();
                /*Modify bird position (bird upcast)*/
                bird.step();
